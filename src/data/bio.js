...
export const bio = {
  ...
  full: {
    zh: [
      ...
      '進入業界後，他在凌華科技、Kontron Asia 等公司擔任產品經理超過十五年，負責工業電腦與嵌入式產品，經手的產品曾獲台灣精品獎與 Computex 台灣最佳外銷資訊產品獎。2008 年底，他加入 LILEE Systems 創始團隊，建立超過 50 人的跨領域團隊，就此跨入創新創業。2014 年成立南星創速器（SSX）投入新創育成；2017 年共同創辦 BiiLabs，用分散式帳本解決物聯網的信任問題；2023 年共同創辦 Tallgeese AI，為企業提供隱私優先的 AI 方案。',
    ...
    en: [
      ...
      'He then spent more than fifteen years as a product manager at ADLINK, Kontron Asia and other hardware companies, working on industrial and embedded computing. Products he managed won the Taiwan Excellence Award and a Computex award for Taiwan\'s best exported IT products. At the end of 2008 he joined the founding team of LILEE Systems and built a cross-functional team of more than 50 people. That was when he moved into startups. He started the SouthStar Xelerator (SSX) accelerator in 2014, co-founded BiiLabs in 2017 to bring distributed-ledger trust to IoT, and co-founded Tallgeese AI in 2023 to offer privacy-first AI to enterprises.',
